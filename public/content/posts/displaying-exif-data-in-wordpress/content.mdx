...
The shortcode is super simple and displays *Timestamp*, *Camera*, *Aperture*, *ISO*, *Shutter Speed*, and *Focal Length*. Because WordPress doesn't save *Location* or _Lens_ information, you would have to pass that in yourself using arguments. Here's the basic usage:
