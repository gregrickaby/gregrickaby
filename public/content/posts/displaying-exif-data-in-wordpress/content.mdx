...
When you upload a JPG to WordPress, it will scan and save _most_ EXIF data as post meta. No plugin or configuration is _needed_!
...
The shortcode is super simple and displays _Timestamp_, _Camera_, _Aperture_, _ISO_, _Shutter Speed_, and _Focal Length_. Because WordPress doesn't save _Location_ or _Lens_ information, you would have to pass that in yourself using arguments. Here's the basic usage:
