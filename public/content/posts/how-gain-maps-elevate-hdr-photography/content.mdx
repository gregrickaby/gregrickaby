...
- [More Nits and Bits](#the-need-for-more-nits-and-bits)
- [What Are Gain Maps?](#what-are-gain-maps)
- [Lightroom Support](#adobe-lightroom-support)
- [Examples](#examples)
- [Too Much of a Good Thing](#too-much-of-a-good-thing)
- [Print in HDR?](#but-can-i-print-in-hdr)
- [Browser & App Support](#browser-app-and-cms-support)
...
The HDR highlights and whites sliders are easy to overdo. This shot from Indiana Jones™️ Epic Stunt Spectacular shows what happens when you push them too far. SDR source:
...
HDR export, with the sliders maxed out:
