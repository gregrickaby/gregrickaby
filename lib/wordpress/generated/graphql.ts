...
export type MediaItemSizeEnum =
  ...
  | 'GFORM_IMAGE_CHOICE_LG'
  /** Custom Image Size. (400x400) */
  | 'GFORM_IMAGE_CHOICE_MD'
  /** Custom Image Size. (300x300) */
  | 'GFORM_IMAGE_CHOICE_SM'
  /** Large image preview suitable for detail views. (3840x2560) */
  | 'LARGE'
  /** Medium image preview typically suitable for listings and detail views. (640x640) */
  | 'MEDIUM'
  /** Medium-to-large image preview suitable for listings and detail views. (768x0) */
  | 'MEDIUM_LARGE'
  /** Small image preview suitable for thumbnails and listings. (300x300) */
  | 'THUMBNAIL'
...
export type MenuLocationEnum =
  ...
  | 'FOOTER'
  /** Put the menu in the menu_1 location */
  | 'MENU_1'
  /** Put the menu in the menu_2 location */
  | 'MENU_2'
  /** Put the menu in the menu_mobile location */
  | 'MENU_MOBILE'
  | '%future added value'
...
export type GetPostBySlugQuery = {
  ...
  post?: {
    ...
    seo?: {
      ...
      schema?: {__typename: 'SEOPostTypeSchema'; raw?: string | null} | null
      breadcrumbs?: Array<{
        __typename: 'SEOPostTypeBreadcrumbs'
        text?: string | null
        url?: string | null
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {kind: 'Field', name: {kind: 'Name', value: 'isSticky'}},
                {kind: 'Field', name: {kind: 'Name', value: 'commentCount'}},
                {kind: 'Field', name: {kind: 'Name', value: 'commentStatus'}},
                {
                  kind: 'Field',
                  name: {kind: 'Name', value: 'featuredImage'},
                  selectionSet: {
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      {
                        kind: 'Field',
                        name: {kind: 'Name', value: 'opengraphUrl'}
                      },
                      {
                        kind: 'Field',
                      ...
                      {
                        kind: 'Field',
                        name: {kind: 'Name', value: 'metaRobotsNoindex'}
                      },
                      {
                        kind: 'Field',
